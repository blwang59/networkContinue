...
# driver = webdriver.PhantomJS()
# s=time.clock()
driver.get("https://academic.microsoft.com/#/search?iq=And(Ty%3D'0'%2CComposite(C.CId%3D1135342153))&q=papers%20in%20conference%20www&filters=&from=0&sort=1")
print('get www')
...
def get_content(d, mode):
    ...
    with codecs.open('./results/acdatas_WWW.csv', mode, encoding='utf-8') as f:
