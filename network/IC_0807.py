...
network = json.load(open('./network_dict_0807_right_weight.json', encoding='utf-8', errors='ignore'))
...
draw_trees('./inter_res/ICres_2136372366.txt', './inter_res/IC0807/chenenhong_10.dot')
