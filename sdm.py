...
# s=time.clock()
driver.get("https://academic.microsoft.com/#/search?iq=%40papers%20in%20conference%20SDM%40&q=papers%20in%20conference%20SDM&filters=&from=0&sort=1")
print('get SDM')
...
def get_content(d, mode):
    ...
    with codecs.open('./tests/acdatas_SDM.csv',mode, encoding='utf-8') as f:
