...
# driver = webdriver.PhantomJS()
# s=time.clock()
driver.get("https://academic.microsoft.com/#/search?iq=And(Ty%3D'0'%2CComposite(CI.CIId%3D631648488))&q=papers%20in%20conference%20SIGIR%202012&filters=&from=0&sort=1")
print('get SIGIR 2012')
...
def get_content(d, mode):
    ...
    with codecs.open('./tests/acdatas_SIGIR_2012.csv', mode, encoding='utf-8') as f:
        f_csv = csv.DictWriter(f, headers)
        # f_csv.writeheader()
        f_csv.writerows(rows)

# def get_by_year(driver,year):
...
#     # driver = webdriver.PhantomJS()
#     # s=time.clock()
#     for i in range(1978,2012):

#     driver.get("https://academic.microsoft.com/#/search?iq=And(Ty%3D'0'%2CComposite(CI.CIId%3D631648488))&q=papers%20in%20conference%20SIGIR%202013&filters=&from=8&sort=1")
#     print('get SIGIR '+str(year))
#     driver.implicitly_wait(10)
#     get_by_year()
