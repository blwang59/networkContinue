...
# driver = webdriver.PhantomJS()
# s=time.clock()
driver.get("https://academic.microsoft.com/#/search?iq=%40papers%20in%20conference%20PKDD%40&q=papers%20in%20conference%20PKDD&filters=&from=744&sort=1")
print('get PKDD')
...
def get_content(d, mode):
    ...
    with codecs.open('./results/acdatas_PKDD.csv', mode, encoding='utf-8') as f:
